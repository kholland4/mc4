Textures and icons named technic_*.png are taken or adapted from the Technic modpack for Minetest.
Licensing info abridged from the modpack's README.md file is as follows:
=====
