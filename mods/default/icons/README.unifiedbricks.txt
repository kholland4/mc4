From [https://github.com/minetest-mods/unifiedbricks/blob/master/README.txt].
Applies to unifiedbricks_*.png
Cube-style icons were auto-generated from the original texture files.
=====
